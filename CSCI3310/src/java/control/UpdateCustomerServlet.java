...
public class UpdateCustomerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //processRequest(request, response);
        System.out.println("YOU'RE IN THE POST SECTION BABY.");
        Customer cust = new Customer();
        AccountReader reader = new AccountReader();
        cust.setUsername(reader.getUsername().toLowerCase());
        cust.setPassword(request.getParameter("password"));
        cust.setEmail(request.getParameter("email").toLowerCase());
        ...
        cust.setPhone(request.getParameter("phonenum"));
