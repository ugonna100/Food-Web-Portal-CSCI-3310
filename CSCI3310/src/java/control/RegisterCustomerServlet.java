...
public class RegisterCustomerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean validated = cust.ValidateCustomer(request.getParameter("username"), request.getParameter("password"));
        
        if (!validated) {
            cust.setUsername(request.getParameter("username").toLowerCase());
