<%-- 
    Document   : cartError
    Created on : Dec 1, 2016, 9:58:32 AM
    Author     : Bakuano
--%>
                    ...
                    <div class="col-sm-4 col-sm-offset-4">
                        <div class="form-box">
                            ...
                            <div class="form-bottom text-center">
                                <h2>Woops</h2>
                                <p>Dude, you already have that in your cart.</p>
                                <form action="ListCartServlet" method="get">
                                <button type="submit" class="btn buttonColor"><i class="fa fa-shopping-cart"></i> Cart</button>
                                </form>
                            </div>
                        </div>
