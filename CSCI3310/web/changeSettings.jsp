<%-- 
    ...
    Created on : Dec 1, 2016, 9:38:01 AM
    Author     : Bakuano
--%>
            ...
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="form-box" style="color: black;">
                        <div class="form-top">
                            <div class="left">
                                <h3 style="padding-bottom: 15px;">Change Account Settings</h3>
                                <p>Enter your new account information</p>
                            </div>
                        ...
                        <div class="form-bottom">
                            <form action="UpdateCustomerServlet" method="post">
                                ...
                                <button type="submit" class="btn buttonColor" value="Submit" id="rsubmit">Change Settings</button>
                            </form>
                        </div>
                    </div>
