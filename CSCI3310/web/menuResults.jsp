<%-- 
    Document   : menuResults
    Created on : Nov 30, 2016, 11:37:51 PM
    Author     : Bakuano
--%>
                                    ...
                                    <tbody>
                                        <c:forEach items="${menuList}" var="menu">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:out value="${menu.type}" />
                                                </td>
                                                <td>
                                                    <form action="AddCartServlet" method="post">
                                                        <input type="radio" name="menuRest" value = "${menu.restName}" checked style="display: none;">
                                                        <input type="checkbox" name="menuFood" value ="${menu.foodName}" checked style="display: none;">
                                                        <input type="checkbox" name="menuPrice" value="${menu.price}" checked style="display: none">
                                                        <button type="submit" class="btn buttonColor" value="Submit" id="rsubmit">Add to Cart</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        </c:forEach>
